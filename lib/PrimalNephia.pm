...
sub import {
    ...
    PrimalNephia::Core->export_to_level(1);

    @_ = @plugins;
    goto do { PrimalNephia::Core->can('nephia_plugins') } if @plugins;
}
...
and controller-logic must return response-value as hash-reference or PrimalNephia::Response object.
...
=head2 Submapping to other applications that use PrimalNephia
...
First, see app.psgi that generated by C<primalnephia-setup>.
...
See L<PrimalNephia::Plugin> for more detail about plugin.
...
L<PrimalNephia Home Page|http://nephia.github.io/>
